...
[![Stars](https://img.shields.io/github/stars/Eita19/self-check?style=flat)](https://github.com/Eita19/self-check)
...
Before any task, run through a checklist:
...
*Based on [Y7 Framework](https://github.com/Y7-ai) + Three Provinces Six Ministries*
